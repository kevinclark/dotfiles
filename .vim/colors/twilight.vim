...
exe 'hi LineNr         guifg='.s:lightgrey     .' guibg='.s:dark_grey_blue  .' gui=none'
...
exe 'hi PreProc        guifg='.s:beige         .' guibg='.s:darkgrey        .' gui=none'
exe 'hi Operator       guifg='.s:light_orange      .' guibg='.s:darkgrey        .' gui=none'
exe 'hi Type           guifg='.s:light_brown            .' guibg='.s:darkgrey        .' gui=italic'
